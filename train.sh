EXP_FLAG=test-smallLR-0.5Clip-5k
accelerate launch --num_cpu_threads_per_process 1 --mixed_precision bf16 fpack_train_network.py \
    ...
    --dataset_config data/i2v/i2v_saylo.toml \
    --sdpa --mixed_precision bf16 \
    --optimizer_type adafactor --learning_rate 0.4e-4 --gradient_checkpointing \
    --max_grad_norm 0.5 \
    ...
    --max_train_epochs 5 --save_every_n_epochs 1 --save_every_n_steps 1000 --seed 42 \
    --output_dir outputs/$EXP_FLAG --output_name $EXP_FLAG \
    --log_with tensorboard --logging_dir logs --log_prefix $EXP_FLAG- \
